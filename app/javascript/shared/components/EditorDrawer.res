      ...
      <div className="w-full relative overflow-y-scroll">
        <div className="md:hidden absolute right-0 pt-3 pr-4 z-50">
          <button
            ...
            title=closeButtonTitle
            className="flex items-center justify-center w-10 h-10 bg-gray-300 text-gray-800 font-bold p-3 rounded-full hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-blue-400">
            <Icon className={closeIconClassName ++ " text-xl"} />
          </button>
        </div>
        children
