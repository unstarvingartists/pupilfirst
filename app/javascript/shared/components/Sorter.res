  ...
  let dropdown = (criteria, selectedCriterion, onCriterionChange) => {
    let selectedForDropdown =
      <button
        ...
        className="flex w-full items-center justify-between leading-relaxed font-semibold bg-white border border-gray-400 rounded focus:outline-none px-2 md:px-3 py-1 md:py-2 focus:ring-2 focus:ring-inset focus:ring-blue-500 ">
    ...
    let dropDownContents =
      ...
      |> Array.map(criterion =>
        <button
          ...
          className="inline-flex items-center w-full font-semibold whitespace-nowrap text-xs p-3 text-left focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 ">
    ...
    <div className="flex">
      {criteria |> Array.length > 1
        ...
        <button
          ...
          className="bg-white w-10 px-2 py-1 rounded border border-gray-400 text-gray-800 hover:bg-gray-200 hover:text-primary-500 focus:ring-2 focus:ring-inset focus:ring-blue-500 "
          onClick={_ => {
