  ...
  if studentDetails |> StudentDetails.teamHasManyStudents {
    <div className="block mb-8">
      ...
      |> Array.map(student => {
        ...
        <Link
          className="block rounded-lg focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
          href=path
        ...
        <div
          ...
          <div className="student-overlay__student-details relative pb-8">
            <button
              ...
              className="absolute z-50 left-0 cursor-pointer top-0 inline-flex p-1 rounded-full bg-gray-200 h-10 w-10 justify-center items-center text-gray-700 hover:text-gray-900 hover:bg-gray-300 focus:outline-none focus:text-gray-900 focus:bg-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-500">
