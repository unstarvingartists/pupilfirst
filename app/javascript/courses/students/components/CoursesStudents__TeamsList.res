...
let showStudent = (team, levels, teamCoaches) => {
  ...
  <Link
    ...
    className="flex md:flex-row justify-between bg-white mt-4 rounded-lg shadow cursor-pointer hover:border-primary-500 hover:text-primary-500 hover:shadow-md focus-within:outline-none focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500">
      ...
      <div className="flex flex-col flex-1 w-full md:w-3/5">
        ...
        |> Array.map(student =>
          <Link
            ...
            " in team " ++
            (team |> TeamInfo.name)}
            className="flex items-center rounded-l-lg bg-white cursor-pointer hover:border-primary-500 hover:text-primary-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
