...
let rendertarget = (target, statusOfTargets, author, courseId) => {
  ...
  <div
    ...
    <Link
      ...
      className="p-6 flex flex-grow items-center justify-between hover:text-primary-500 cursor-pointer focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 focus:text-primary-500 focus:bg-gray-100 focus:rounded-lg"
    ...
    {ReactUtils.nullUnless(
      <a
        ...
        className="hidden lg:block courses-curriculum__target-quick-link text-gray-400 border-l border-transparent py-6 px-3 hover:text-primary-500 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 focus:bg-gray-100 focus:text-primary-500 focus:rounded-lg">
...
let navigationLink = (direction, level, setState) => {
  ...
  <button
    ...
    className="block w-full focus:outline-none p-4 text-center border rounded-lg bg-gray-100 hover:bg-gray-200 cursor-pointer hover:text-primary-500 focus:text-primary-500 focus:bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-blue-500">
    {arrow(leftIcon)}
