    ...
    <div className="bg-white flex justify-between w-full">
      <div className="flex flex-col md:flex-row w-full md:w-auto">
        <div className="flex flex-1 md:flex-none justify-between border-b md:border-0">
          <button
            ...
            className="flex flex-col items-center justify-center leading-tight px-3 py-2 md:px-5 md:py-4 cursor-pointer border-r bg-white text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 ring-inset ">
        ...
        <div className="px-4 py-3">
          <div className="block text-sm md:pr-2">
            ...
            <a
              ...
              target="_blank"
              className="ml-2 font-semibold underline text-gray-900 hover:bg-primary-100 hover:text-primary-600 text-base focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            }}
            {
              ...
              Js.Array.mapi((student, index) => {
                ...
                <span key={Student.id(student)}>
                  <a
                    className="font-semibold underline focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      ...
      <div className="hidden md:flex flex-shrink-0 space-x-6">
        ...
        {reviewNextButton(
          ...
          filter,
          submissionId,
          "flex items-center border-l text-sm font-semibold px-5 py-4 hover:bg-gray-200 hover:text-primary-500 focus:ring-2 focus:ring-blue-500 ring-inset ",
        )}
      </div>
    </div>
  </div>
...
let gradePillClasses = (selectedGrade, currentGrade, passgrade, send) => {
  let defaultClasses =
    ...
    switch send {
    | Some(_) =>
      "cursor-pointer hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 " ++ (
                  ...
                  <div
                    ...
                    <div className="flex justify-center ml-2 md:ml-4">
                      <button
                        ...
                        className="btn btn-small bg-red-100 text-red-800 hover:bg-red-200 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
