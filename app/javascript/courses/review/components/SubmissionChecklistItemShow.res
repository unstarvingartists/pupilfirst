  ...
  <div className="flex flex-wrap">
    ...
    ->Js.Array2.map(file =>
      <a
        ...
        target="_blank"
        className="mt-1 mr-3 flex border overflow-hidden rounded hover:shadow-md border-pink-400 bg-white text-pink-700 hover:border-pink-600 hover:text-pink-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        <span
...
let showlink = link =>
  <a
    href=link
    target="_blank"
    className="max-w-fc mt-1 mr-3 flex border overflow-hidden rounded hover:shadow-md border-blue-400 bg-white text-blue-700 hover:border-blue-600 hover:text-blue-800 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    <span
      className="course-show-attachments__attachment-title rounded text-xs font-semibold inline-block whitespace-nowrap truncate w-32 md:w-42 h-full px-3 py-2 leading-loose">
      {link->str}
    </span>
...
let statusButton = (index, status, callback, checklist) =>
  <div className="mt-2">
    <button
      ...
      className={"border border-gray-500 rounded focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 " ++
