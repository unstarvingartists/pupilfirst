...
let contents = (courses, currentCourse, selectedPage) => {
  Js.Array.map(
    course =>
      <a
        className="block px-4 py-3 text-xs font-semibold text-gray-900 border-b border-gray-200 bg-white hover:text-primary-500 hover:bg-gray-200 whitespace-normal focus:ring-2 focus:ring-inset focus:ring-blue-500 "
